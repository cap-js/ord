const { OPEN_RESOURCE_DISCOVERY_VERSION, SHORT_DESCRIPTION_PREFIX, RESOURCE_VISIBILITY } = require("../common/constants");
const { hasSAPPolicyLevel } = require("../common/utils");
