...
function createProduct(appConfig) {
    return {
        ...
        title: nameWithSpaces(appConfig.appName),
        ordId: `customer:product:${nameWithDot(appConfig.appName)}:`,
        shortDescription: `Short description of ${nameWithSpaces(appConfig.appName)}`,
    };
}
