...
module.exports = async (data) => {
    ...
    const javaFilePathMap = {
        "oas3": path.join(cds.root, 'src/main/resources/openapi', `${serviceName}.openapi.json`),
        "asyncapi2": path.join(cds.root, 'src/main/resources/asyncapi', `${serviceName}.json`),
        "edmx": path.join(cds.root, 'src/main/resources/edmx/odata/v4', `${serviceName}.xml`)
    };
