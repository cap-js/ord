    ...
    consumptionBundles: (appConfig) => [
        {
            ...
            shortDescription: "Resources accessible without authentication",
            description:
                "This Consumption Bundle contains all resources which are unprotected and do not require authentication",
        },
    ],
