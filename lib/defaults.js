...
const mapEnvPackageInfo = (appConfigEnv) => {
    if (!appConfigEnv) {
        return { vendor: undefined };
    }

    // complete list at https://pages.github.tools.sap/CentralEngineering/open-resource-discovery-specification/spec-v1/interfaces/document#package
    return appConfigEnv;
};
