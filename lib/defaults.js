...
module.exports = {
  ...
  packages: function getPackageData (name) {
    const oCdsrc = require('../xmpl/.cdsrc.json');
    ...
    const policyLevel = oCdsrc.ord.policyLevel;

    if (policyLevel.includes(':') && policyLevel.split(':')[0].trim().toLowerCase() === 'sap') {
