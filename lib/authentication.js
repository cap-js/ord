...
const { AUTHENTICATION_TYPE, BASIC_AUTH_HEADER_KEY } = require("./constants");
...
async function authenticate(req, res, next) {
    ...
    if (!Object.keys(req.headers).includes(BASIC_AUTH_HEADER_KEY) && authTypes.includes(AUTHENTICATION_TYPE.Basic)) {
