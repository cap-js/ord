            ...
            if (apiProtocol === ORD_API_PROTOCOL.SAP_DATA_SUBSCRIPTION) {
                ...
                resourceDefinitions = [
                    _getResourceDefinition(
                        ORD_RESOURCE_DEFINITION_TYPE.CSN_INTEROP,
                        ORD_MEDIA_TYPE.JSON,
                        ordId,
                        serviceName,
                        ORD_FILE_EXTENSION.CSN_JSON,
                        accessStrategies,
                    ),
                ];
                ...
                resourceDefinitions = [
                    _getResourceDefinition(
                        ORD_RESOURCE_DEFINITION_TYPE.OPENAPI_V3,
                        ORD_MEDIA_TYPE.JSON,
                        ordId,
                        serviceName,
                        ORD_FILE_EXTENSION.OAS3_JSON,
                        accessStrategies,
                    ),
                ];
                ...
                resourceDefinitions = [
                    _getResourceDefinition(
                        ORD_RESOURCE_DEFINITION_TYPE.GRAPHQL_SDL,
                        ORD_MEDIA_TYPE.TEXT_PLAIN,
                        ordId,
                        serviceName,
                        ORD_FILE_EXTENSION.GRAPHQL,
                        accessStrategies,
                    ),
                ];
            } else {
                ...
                resourceDefinitions = [
                    ...
                    _getResourceDefinition(
                        ORD_RESOURCE_DEFINITION_TYPE.EDMX,
                        ORD_MEDIA_TYPE.XML,
                        ordId,
                        serviceName,
                        ORD_FILE_EXTENSION.EDMX,
                        accessStrategies,
                    ),
                ];
            }
...
const createEventResourceTemplate = (serviceName, serviceDefinition, appConfig, packageIds, accessStrategies) => {
    ...
    let obj = {
        ...
        resourceDefinitions: [
            _getResourceDefinition(
                ORD_RESOURCE_DEFINITION_TYPE.ASYNCAPI_V2,
                ORD_MEDIA_TYPE.JSON,
                ordId,
                serviceName,
                ORD_FILE_EXTENSION.ASYNCAPI2_JSON,
                accessStrategies,
            ),
        ],
        extensible: { supported: "no" },
