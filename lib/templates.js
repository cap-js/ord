...
/**
 * This is a function to create entityTypeMappings array for service or event resource.
 * @param serviceDefinition The service/event definition object.
 * @returns {[{entityTypeTargets: *}]|*[]} An array of entityTypeMappings objects or an empty array.
 * @private
 */
function _getEntityTypeMappings(serviceDefinition) {
    const entities = Object.values(serviceDefinition.entities).map(createEntityTypeMappingsItemTemplate)
