...
const { AUTHENTICATION_TYPE, AUTH_TYPE_ORD_ACCESS_STRATEGY_MAP } = require("./constants");
    ...
    paths.forEach((generatedPath) => {
        let resourceDefinitions = [
            {
                ...
                url: `/ord/v1/documents/api-metadata/${serviceName}.oas3.json`,
                accessStrategies: [
                    {
        ...
        if (generatedPath.kind !== "rest") {
            ...
            resourceDefinitions.push({
                ...
                url: `/ord/v1/documents/api-metadata/${serviceName}.edmx`,
                accessStrategies: [
                    {
                        type: AUTH_TYPE_ORD_ACCESS_STRATEGY_MAP[getAuthenticationType()] || AUTHENTICATION_TYPE.Open,
                    },
        ...
        resourceDefinitions: [
            {
                type: "asyncapi-v2",
                mediaType: "application/json",
                url: `/ord/v1/documents/api-metadata/${serviceName}.asyncapi2.json`,
                accessStrategies: [
                    {
                        type: AUTH_TYPE_ORD_ACCESS_STRATEGY_MAP[getAuthenticationType()] || AUTHENTICATION_TYPE.Open,
                    },
