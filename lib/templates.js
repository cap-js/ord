...
const fReplaceSpecialCharacters = (namespace) => {
  // TODO: rename group1
  // TODO: why needs to replace all special characters?
...
function _getGroupID(fullyQualifiedName, groupTypeId = defaults.groupTypeId, isService = true) {
    if (isService) {
      // TODO: get rid of global!!! and pay attention to global.namespace and global.capNamespace
 ...
 */
// TODO: remove all unused comments and rename the parameters
...
const fCreateGroupsTemplateForService = (srv, srvDefinition, groupIds) => {
    ...
    // TODO: why is this check necessary and check length > 0?
 ...
 * @returns {Object} A group object.
 */
// TODO: the logic is similar to fCreateGroupsTemplateForService, can we reuse it?
...
const fCreateEventResourceTemplate = (srv, srvDefinition, global,packageIds) => {
  ...
  return {
    ...
    // TODO: default value is correct? Example ODM Event
    ...
    resourceDefinitions: [
      {
        type: "asyncapi-v2",
        mediaType: "application/json",
        url: `/.well-known/open-resource-discovery/v1/api-metadata/${srvDefinition.name}.asyncapi2.json`,
        accessStrategies: [
          {
            type: "open",
          },
...
function checkEntityFunctionAction(srvDefinition, global) {
  ...
  //TODO: missing else condition, e.g error handling
}
