...
function addCustomORDContentIfExist(global, oReturn) {
...
module.exports = (csn) => {
    ...
    oReturn = addCustomORDContentIfExist(global, oReturn);

    return oReturn;
}

if (process.env['NODE_DEV'] == 'TEST') {
    module.exports.addCustomORDContentIfExist = addCustomORDContentIfExist;
}
