...
const { getOrdAccessStrategies } = require("./auth/authentication");
...
module.exports = (csn) => {
    ...
    // Get access strategies - always returns valid strategies, falls back to 'open' if config is invalid
    const accessStrategies = getOrdAccessStrategies();
