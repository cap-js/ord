 ...
 */
const fGetPackages = (policyLevel,global) => global.env?.packages || (global.aEvents.length) ? defaults.packages(global.namespace,policyLevel) : defaults.packages(global.namespace,policyLevel).slice(0, 1)
 ...
 */
const fGetConsumptionBundles = (global) => global.env?.consumptionBundles || (global.aEvents.length) ? defaults.consumptionBundles(global.namespace) : defaults.consumptionBundles(global.appName).slice(0,1)
