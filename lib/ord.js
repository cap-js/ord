...
function _handleService(serviceName, serviceDefinition) {
...
function _shouldSkipIfServiceOnlyContainsEvents(serviceDefinition) {
    return (
        serviceDefinition.entities &&
        Object.keys(serviceDefinition.entities).length === 0 &&
        serviceDefinition.events &&
        Object.keys(serviceDefinition.events).length > 0
    );
}
