...
const initializeAppConfig = (csn) => {
    ...
    const events = [];
    const externalServiceKeys = Object.keys(packageJson.cds.requires);
    const serviceNames = [];
...
module.exports = (csn) => {
    ...
    ordDocument.integrationDependency = _getIntegrationDependencies(linkedCsn, appConfig, packageIds);
