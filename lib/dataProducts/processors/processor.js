...
const DpdAllowlistGuardProcessor = require("../dpd/processors/dpdAllowlistGuardProcessor");
...
class DataProductProcessorChain {
    ...
    buildChain() {
        ...
        const dpdAllowlistGuardProcessor = new DpdAllowlistGuardProcessor();
        ...
        defaultsProcessor
            .setNext(dpdAllowlistGuardProcessor)
