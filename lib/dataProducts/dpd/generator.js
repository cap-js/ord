...
const { initializeSchemas } = require("../common/schemaAllowlistService");
...
async function generateDataProductFiles(csn, appConfig) {
    ...
    // Initialize schemas for allowlist validation
    ...
    const dataProducts = await processor.process(context);
