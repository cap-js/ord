...
function _collectServices(linkedCsn, config) {
    ...
    for (const [name, definition] of Object.entries(linkedCsn.definitions)) {
        ...
        if (_isEventOnlyService(definition)) continue;
...
function _collectEntities(linkedCsn, config) {
    ...
    for (const [name, definition] of Object.entries(linkedCsn.definitions)) {
        ...
        if (!_isExposedEntity(definition)) continue;
...
function _isEventOnlyService(definition) {
...
function _isExposedEntity(definition) {
