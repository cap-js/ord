...
const { stripNamespacePrefix, findPackageId } = require("./naming");
const { mergeResourceProperties } = require("./apiResource");

function createEventResources(service, config, packageIds, accessStrategies) {
...
module.exports = { createEventResources };
