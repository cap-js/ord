...
const { ORD_API_PROTOCOL } = require("../../../lib/common/constants");
const { resolveApiResourceProtocol, _getExplicitProtocol } = require("../../../lib/core/protocol-resolver");
const { isPrimaryDataProductService } = require("../../../lib/core/templates");
