...
const { CDS_ELEMENT_KIND } = require("../../../lib/common/constants");
...
beforeAll(() => {
    ...
    jest.spyOn(require("../../../lib/common/date"), "getRFC3339Date").mockReturnValue("2024-11-04T14:33:25+01:00");
});
...
describe("Tests for Data Product definition", () => {
    ...
    it("Check interop CSN annotation mapping through ORD", async () => {
        ...
        await jest.isolateModules(() => {
            const cds = require("@sap/cds");
            jest.spyOn(require("../../../lib/common/date"), "getRFC3339Date").mockReturnValue("2024-11-04T14:33:25+01:00");
            const ordLocal = require("../../../lib/core/ord");
