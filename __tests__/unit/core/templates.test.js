...
describe("templates", () => {
    ...
    describe("createAPIResourceTemplate", () => {
        ...
        describe("MCP protocol resource definitions", () => {
            const { MCP_RESOURCE_DEFINITION_TYPE } = require("../../../lib/common/constants");
            ...
            it("should create correct resource definition for MCP protocol", () => {
                ...
                jest.doMock("../../../lib/core/protocol-resolver", () => ({
                ...
                const { createAPIResourceTemplate: createAPIResourceTemplateMocked } = require("../../../lib/core/templates");
                ...
                jest.dontMock("../../../lib/core/protocol-resolver");
                jest.resetModules();
            });
        });
    });
